...
export default function UseMemo() {
  return (
    <Wrapper title={"useMemo"}>
      <p>
        <Highlight>useMemo</Highlight> is a hook that helps optimize performance
        by caching the
      </p>
      ...
      <p>
        That’s what <Highlight>useMemo</Highlight> does: memoizes (remembers)
        expensive results.
      </p>
      <p>💡 When to Use</p>
      <div>
